 ...
 * LLMenu.java
 *
 * Created on Jun 6, 2016, 10:14:35 PM
 */
...
public class LLMenu extends javax.swing.JFrame {

  private java.util.LinkedList <LinkedListObject> persons;
  LinkedList LinkedList;

    public LLMenu(LinkedList l) {
        this.LinkedList=l;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("LinkedList Data Entering");
        ...
        jLabel6.setText("BANK A CCOUNT Nr3");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         setPersons(persons);
         LinkedList.setPersons(persons);

        String allPersons="";
        for (int i = 0; i < persons.size(); i++) {
            LinkedListObject object = persons.get(i);
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LLMenu(new LinkedList()).setVisible(true);
            }
        });
    }
