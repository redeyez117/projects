 ...
 * @author hp
 */
public class AddStack extends javax.swing.JFrame {

  
    public AddStack(Stack stackClassp) {
        initComponents();
        this.stackClass=stackClassp;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(getPersons()==null){
            setPersons(new java.util.Stack());
        }
       ...
       StackObject newPerson = new StackObject();
       newPerson.setName(n);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        //setPersons(persons);
        stackClass.setMainStack(persons);
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddStack(new Stack(null)).setVisible(true);
            }
        });
    }
    ...
    public java.util.Stack getPersons() {
        return persons;
    }


    public void setPersons(java.util.Stack persons) {
